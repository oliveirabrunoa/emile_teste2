...
class Institution(Base):
    ...
    ##Relationships##
    institutions = relationship('Program',back_populates='institution')
...
class Users(Base):
    ...
    course_sections = relationship('CourseSections',back_populates='teacher')
...
class Program(Base):
    ...
    institution = relationship('Institution',back_populates='institutions',lazy='joined')
...
class CourseSections(Base):
    ...
    course_id = Column('courses_sections_courses_id',Integer,ForeignKey('IFCOURSES.courses_id'))
    ...
    teacher = relationship('Users',back_populates='course_sections',lazy='joined')
